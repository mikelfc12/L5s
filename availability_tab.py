...
AVAILABLE_DATES = [
    "July Wednesday 1st (ENG group winners R32)",
    
    "July Tuesday 7th (ENG group 3RD R32)",
    "July Wednesday 8th",
    "July Thursday 9th",
    
    "July Tuesday 14th (ENG group RU SF)",
    "July Wednesday 15th (ENG group winners SF)",
    "July Tuesday 16th  (ENG group 3RD SF)"
